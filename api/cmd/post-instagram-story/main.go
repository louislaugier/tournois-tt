...
func main() {
	idFlag := flag.Int("id", 0, "Tournament ID to post to Instagram story")
	flag.Parse()
	...
	log.Printf("🏓 Posting tournament %d to Instagram Story only...\n", *idFlag)
	...
	// Confirm
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Println("⚠️  ABOUT TO POST TO INSTAGRAM STORY")
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Println()
	fmt.Println("This will post ONLY to Instagram Story (no feed, no threads)")
	fmt.Println()
	...
	// Post to Instagram Story only
	log.Println("📸 Posting to Instagram Story...")
	notification, err := client.PostTournamentStoryOnly(tournamentImage)
	if err != nil {
	...
	log.Println()
	log.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	log.Printf("✅ SUCCESS - Posted to Instagram Story!")
	log.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	log.Println()
	log.Printf("Story ID: %s", notification.MessageID)
