          ...
          >
            ...
            {tournament.rules?.url && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                <a 
                  href={`${tournament.rules.url}${tournament.rules.url.includes('?') ? '&' : '?'}utm_source=tournois-tt.fr&utm_medium=website&utm_campaign=fftt_rules&utm_content=feed_detail`} 
                  target="_blank" 
                  ...
                  onClick={() => {
                    if (typeof window !== 'undefined' && window.gtag) {
                      window.gtag('event', 'click', {
                        ...
                        event_label: 'FFTT Rules - Feed Detail',
